...
export const T: Record<string, Entry> = {
  ...
  'records.loadMore': { en: 'Load older records', hi: 'पुराने रिकॉर्ड दिखाएँ' },
  'chat.sendLabel': { en: 'Send message', hi: 'संदेश भेजें' },
  'em.offlineNote': {
    en: 'Offline — showing your saved copy from {date}. Call buttons still work.',
    hi: 'ऑफ़लाइन — {date} की सहेजी प्रति दिख रही है। कॉल बटन फिर भी काम करते हैं।',
  },
  'rem.medOn': { en: 'Turn on dose reminders', hi: 'डोज़ रिमाइंडर चालू करें' },
  'rem.medOff': { en: 'Turn off dose reminders', hi: 'डोज़ रिमाइंडर बंद करें' },
  'rem.medDesc': {
    en: 'A push at each dose time, read from your medicine frequencies — “twice daily” rings at 9:00 and 21:00.',
    hi: 'हर डोज़ के समय पुश — दवा की आवृत्ति से पढ़कर; “दिन में दो बार” = 9:00 और 21:00 बजे।',
  },
  'rem.medOnInfo': { en: 'Dose reminders are on for this browser.', hi: 'इस ब्राउज़र पर डोज़ रिमाइंडर चालू हैं।' },
  'rem.medOffInfo': { en: 'Dose reminders are off.', hi: 'डोज़ रिमाइंडर बंद हैं।' },
  ...
  'admin.sub': {
    en: 'Platform oversight: totals, activity, service health, and the user directory.',
    hi: 'प्लेटफ़ॉर्म निगरानी: कुल आँकड़े, गतिविधि, सेवा स्थिति और उपयोगकर्ता सूची।',
  },
  'admin.users': { en: 'Accounts', hi: 'खाते' },
  'admin.familyProfiles': { en: 'Family profiles', hi: 'पारिवारिक प्रोफ़ाइल' },
  'admin.records': { en: 'Records', hi: 'रिकॉर्ड' },
  'admin.carePlans': { en: 'Care plans', hi: 'केयर प्लान' },
  'admin.medications': { en: 'Medications', hi: 'दवाएँ' },
  'admin.vitals': { en: 'Readings', hi: 'रीडिंग' },
  'admin.chats': { en: 'Chat messages', hi: 'चैट संदेश' },
  'admin.shareLinks': { en: 'Active share links', hi: 'सक्रिय साझा लिंक' },
  'admin.svcBackend': { en: 'Backend', hi: 'बैकएंड' },
  'admin.svcDb': { en: 'Database', hi: 'डेटाबेस' },
  'admin.svcEngine': { en: 'AI engine', hi: 'AI इंजन' },
  'admin.trendTitle': { en: 'Last {n} days', hi: 'पिछले {n} दिन' },
  'admin.segmentsTitle': { en: 'User segments', hi: 'उपयोगकर्ता वर्ग' },
  'admin.segActive': { en: 'Active (last 7 days)', hi: 'सक्रिय (पिछले 7 दिन)' },
  'admin.segActiveShort': { en: 'Active 7d', hi: 'सक्रिय 7दिन' },
  'admin.seg2fa': { en: '2FA enabled', hi: '2FA सक्षम' },
  'admin.segAbha': { en: 'ABHA linked', hi: 'ABHA लिंक्ड' },
  'admin.segFamily': { en: 'Caring for family', hi: 'परिवार की देखभाल' },
  'admin.trendSignups': { en: 'Sign-ups', hi: 'नए खाते' },
  'admin.trendRecords': { en: 'Uploads', hi: 'अपलोड' },
  'admin.trendVitals': { en: 'Readings', hi: 'रीडिंग' },
  'admin.trendChats': { en: 'Chats', hi: 'चैट' },
  'admin.usersTitle': { en: 'User directory', hi: 'उपयोगकर्ता सूची' },
  'admin.searchPh': { en: 'Search name or email…', hi: 'नाम या ईमेल खोजें…' },
  'admin.noUsers': { en: 'No matching users.', hi: 'कोई मिलान नहीं मिला।' },
  'admin.colUser': { en: 'User', hi: 'उपयोगकर्ता' },
  'admin.colJoined': { en: 'Joined', hi: 'शामिल हुए' },
  'admin.colSecurity': { en: 'Security', hi: 'सुरक्षा' },
  'admin.colLastActive': { en: 'Last active', hi: 'अंतिम सक्रिय' },
  'admin.privacyNote': {
    en: 'Metadata only — patient content is never shown here.',
    hi: 'केवल मेटाडेटा — मरीज़ की सामग्री यहाँ कभी नहीं दिखती।',
  },
  'admin.footer': {
    en: 'Admin access is granted by server configuration (ADMIN_EMAILS); it cannot be granted through the API.',
    hi: 'एडमिन पहुँच सर्वर कॉन्फ़िगरेशन (ADMIN_EMAILS) से मिलती है; API से नहीं दी जा सकती।',
  },
  ...
  'chat.widgetClose': { en: 'Close', hi: 'बंद करें' },
  'chat.voiceStart': { en: 'Speak your question', hi: 'बोलकर पूछें' },
  'chat.voiceStop': { en: 'Stop listening', hi: 'सुनना बंद करें' },
  'chat.listening': { en: 'Listening…', hi: 'सुन रहा है…' },
  'records.filterAll': { en: 'All', hi: 'सभी' },
  'records.sortNewest': { en: 'Newest', hi: 'नवीनतम पहले' },
  'records.sortOldest': { en: 'Oldest', hi: 'पुरानी पहले' },
  'records.noneOfType': { en: 'No records of this type yet.', hi: 'इस प्रकार का कोई रिकॉर्ड अभी नहीं है।' },
  'plans.statusDraft': { en: 'Not started', hi: 'शुरू नहीं हुआ' },
  'plans.statusActive': { en: 'Active', hi: 'चालू' },
  'plans.statusDay': { en: 'Day {x} of {n}', hi: 'दिन {x} / {n}' },
  'plans.statusCheckin': { en: 'Check-in due', hi: 'जाँच बाकी' },
  'plans.statusDone': { en: 'Completed', hi: 'पूर्ण' },
  'share.title': { en: 'Share with doctor or family', hi: 'डॉक्टर या परिवार के साथ साझा करें' },
  'share.desc': {
    en: 'Create a read-only link to this profile’s medications, latest care plan, and recent vitals. Anyone with the link can view it — no account needed. Links expire in 30 days and can be revoked anytime.',
    hi: 'इस प्रोफ़ाइल की दवाओं, नवीनतम केयर प्लान और हाल की रीडिंग का केवल-पढ़ने योग्य लिंक बनाएँ। लिंक पाने वाला कोई भी इसे देख सकता है — खाते की ज़रूरत नहीं। लिंक 30 दिन में समाप्त होते हैं और कभी भी रद्द किए जा सकते हैं।',
  },
  'share.createBtn': { en: 'Create share link', hi: 'साझा लिंक बनाएँ' },
  'share.copy': { en: 'Copy', hi: 'कॉपी' },
  'share.copied': { en: 'Copied!', hi: 'कॉपी हो गया!' },
  'share.revoke': { en: 'Revoke', hi: 'रद्द करें' },
  'share.expires': { en: 'Expires', hi: 'समाप्ति' },
  'share.invalid': {
    en: 'This share link is invalid, revoked, or has expired.',
    hi: 'यह साझा लिंक अमान्य है, रद्द किया गया है, या समाप्त हो चुका है।',
  },
  'share.sharedFor': { en: 'Health summary — {name}', hi: 'स्वास्थ्य सारांश — {name}' },
  'share.generated': { en: 'Generated', hi: 'तैयार किया गया' },
  'share.readOnly': { en: 'read-only', hi: 'केवल पढ़ने योग्य' },
  'share.latestPlan': { en: 'Latest care plan', hi: 'नवीनतम केयर प्लान' },
  'share.redFlags': { en: 'Watch for these red flags', hi: 'इन चेतावनी संकेतों पर नज़र रखें' },
  'share.footer': {
    en: 'Shared via Curastra. This summary is informational and not medical advice.',
    hi: 'Curastra से साझा। यह सारांश केवल जानकारी के लिए है, चिकित्सा सलाह नहीं।',
  },
  'em.title': { en: 'Emergency Card', hi: 'आपातकालीन कार्ड' },
  'em.sub': {
    en: 'The essentials for a first responder, and one tap to call for help.',
    hi: 'आपात स्थिति में मददगार ज़रूरी जानकारी, और मदद बुलाने के लिए एक टैप।',
  },
  'em.cardNote': {
    en: 'Show this card to medical responders.',
    hi: 'यह कार्ड चिकित्सा सहायता कर्मियों को दिखाएँ।',
  },
  'em.callTitle': { en: 'Call for help', hi: 'मदद के लिए कॉल करें' },
  'em.callEmergency': { en: 'Call 112 (emergency services)', hi: '112 पर कॉल करें (आपातकालीन सेवा)' },
  'em.callContact': { en: 'Call {name}', hi: '{name} को कॉल करें' },
  'em.confirmCall': { en: 'Tap again to call', hi: 'कॉल के लिए फिर टैप करें' },
  'em.noContact': {
    en: 'No emergency contact saved yet. Add one under',
    hi: 'अभी कोई आपातकालीन संपर्क नहीं है। यहाँ जोड़ें:',
  },
  'em.desktopNote': {
    en: 'On a phone, these buttons open the dialer. On a computer, dial the number shown.',
    hi: 'फ़ोन पर ये बटन डायलर खोलते हैं। कंप्यूटर पर दिखाया गया नंबर स्वयं डायल करें।',
  },
